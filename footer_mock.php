		...
		<footer class="footer" role="contentinfo">
			...
			<div class="footer-group">
				<div class="footer-faculties">
					<button class="footer-title collapse-title collapsed" type="button" data-toggle="collapse" data-target="#collapse-fac" aria-expanded="false"
			...
			<div class="footer-group footer-socials">
				...
				<div class="footer-social">
					<a href="#" class="social-icon social-icon-facebook social-icon-negative">
						...
						<span class="sr-only">Follow us on icon-facebook.</span>
					</a>
					<a href="#" class="social-icon social-icon-twitter social-icon-negative">
						<svg class="icon" aria-hidden="true">
							<use xlink:href="#icon-twitter"></use>
						</svg>
						<span class="sr-only">Follow us on icon-twitter.</span>
					</a>
					...
					<a href="#" class="social-icon social-icon-googleplus social-icon-negative">
						...
						<span class="sr-only">Follow us on icon-googleplus.</span>
					</a>
				</div>
			</div>
