...
wp_enqueue_script( 'epfl-labs-search-listjs', __DIR__. '/lib/list.js', ['jquery'], 1.5, true);
wp_enqueue_style( 'epfl-labs-search-css',  __DIR__. '/epfl-labs-search.css',false,'1.0','all');
